...
const AntiFraudPolicy = () => {
  return (
    <div className="bg-gray-100">
      <CarouselBanner />
      <ContainerWrapper>
        <HeadingWrapper heading={"Anti-Fraud Policy"} title={metaData.title}>
          <div className="px-4 mt-4 flex flex-col gap-2">
            ...
            <p className="text-gray-600 text-sm font-medium">
              ...
              Having no relevance to {metaData.title}
            ...
            <p className="text-gray-600 text-sm font-medium">
              {metaData.title} suggest you, if you find any type of fraud or
              scam with our agent or representative please contact us
