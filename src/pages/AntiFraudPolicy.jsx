        ...
        >
          <div className="px-4 mt-4 flex flex-col gap-2">
            ...
            <p className="text-gray-600 text-sm font-medium">
              ...
              Having no relevance to Fundwisor Finance Business Solution Pvt.
              Ltd. then never make this kind of Payments Also never pay any
              amount to any person claiming that he/she is an agent or
              representative of Financial Services Private Limited outside the
            ...
            <p className="text-gray-600 text-sm font-medium">
              Fundwisor Finance Business Solution Pvt. Ltd. suggest you, if you
              find any type of fraud or scam with our agent or representative
              please contact us immediately. We are always happy to help you.
            </p>
          </div>
        </HeadingWrapper>
      </ContainerWrapper>
