        ...
        >
          ...
          >
            {({
              ...
              <form onSubmit={handleSubmit} className="flex pb-4 items-start gap-4 md:gap-24 justify-start flex-col md:flex-row  mt-4 p-0 md:p-8 lg:px-20  ">
                ...
                <div className="flex  items-center flex-col gap-2">
                  ...
                  <Input
                    ...
                    icon={
                      <IdentificationIcon className="w-4 text-indigo-500" />
                    }
                    label={"Adhaar Number"}
                  ...
                  <p className="text-md max-w-md text-left ">
                    ...
                    and belief. In case any information given in this
                    application proves to be false or incorrect, I shall be
