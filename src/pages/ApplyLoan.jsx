      ...
      <ContainerWrapper>
        <div className="p-0 md:p-4">
          <h1 className="text-xl  py-4 border-b-4 px-2 rounded-2xl border-red-500 text-center font-extrabold">
            <span className="text-orange-700 text-2xl ">APPLY FOR LOAN</span>{" "}
          </h1>
        </div>
        <Formik
          ...
          {({
            ...
            >
              <div className="flex  items-center  flex-col gap-2">
                <h3 className="text-3xl text-left w-full font-bold text-orange-800">
                ...
                />
                <span className="text-3xl text-left w-full font-bold text-orange-800">
                  Date of Birth
                </span>
                <Input
                  name="dob"
              ...
              <div className="flex  items-center flex-col gap-2">
                ...
                >
                  <span className="front bg-orange-700 hover:bg-orange-900 hover:text-white px-4 py-2  rounded-3xl font-semibold">
