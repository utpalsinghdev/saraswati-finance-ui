...
const Select = ({
  ...
  const selectClasses = classNames(
    "w-full px-4 py-3 border rounded-lg transition-all duration-200 bg-white focus:outline-none focus:ring-2 focus:ring-offset-0 appearance-none cursor-pointer",
    {
  ...
  const iconClasses = classNames(
    "absolute top-1/2 transform -translate-y-1/2 pointer-events-none flex items-center justify-center",
    {
  ...
  const arrowClasses = classNames(
    "absolute top-1/2 right-4 transform -translate-y-1/2 pointer-events-none text-neutral-400 flex items-center justify-center w-5 h-5",
    {
      "right-12": icon && iconPosition === "right",
    }
  );
